...
export default function DailySpirit({ rituals, onToggleRitual }: DailySpiritProps) {
  ...
  return (
    <div className="w-full bg-[#161618]/60 backdrop-blur-xl border border-white/10 py-7 px-8 rounded-2xl flex flex-col items-center justify-center gap-5 hover:bg-white/[0.04] hover:border-[#D1FF26]/20 transition-all duration-300 group shadow-[0_0_30px_-10px_rgba(209,255,38,0.05)] relative overflow-hidden">
      <div className="absolute top-0 left-0 w-8 h-px bg-[#D1FF26]"></div>
        ...
        <svg className="w-full h-full transform -rotate-90" viewBox="0 0 100 100">
          <defs>
            <linearGradient id="ringGrad" x1="0%" x2="100%" y1="0%" y2="100%">
              <stop offset="0%" stopColor="#D1FF26" stopOpacity={1} />
          ...
          <circle
            ...
            className="transition-all duration-1000 ease-out drop-shadow-[0_0_8px_rgba(209,255,38,0.25)]"
          />
        </svg>
      ...
      <div className="text-center">
        <h3 className="font-mono text-xs uppercase tracking-[0.2em] font-bold text-[#D1FF26]">
          Daily Spirit
        </h3>
      ...
      <button
        ...
        className="flex items-center gap-1.5 text-[10px] text-[#D1FF26] font-bold tracking-wider uppercase hover:opacity-80 active:scale-95 transition-all mt-1 cursor-pointer font-mono"
      >
        ...
        <div className="w-full border-t border-white/5 pt-4 mt-1 flex flex-col gap-2 animate-fadeIn">
          {rituals.map((r) => (
            <div
              ...
              className="flex items-center justify-between p-3 rounded-xl bg-white/[0.01] hover:bg-[#161618] border border-white/5 hover:border-[#D1FF26]/20 transition-all cursor-pointer group"
            >
              ...
              <div
                className={`w-5 h-5 rounded flex items-center justify-center transition-all ${
                  r.completed
                    ...
                    : "border border-zinc-700 hover:border-[#D1FF26]"
                }`}
              >
